...
public:
    Train(Size size=COMPILE_MAX_BOARD_LEN, uint32_t state_c=2, uint32_t n_thread=6, double lr=4e-3, double c_lr=1, double temp=1, uint32_t n_simulate=400,
          uint32_t c_puct=5, double virtual_loss=3, uint32_t buffer_size=10000, uint32_t batch_size=256, uint32_t epochs=train_epoch, double kl_targ=0.02, uint32_t check_freq=30, uint32_t n_game=2000) :
